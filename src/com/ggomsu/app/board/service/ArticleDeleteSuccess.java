...
// 작성자 : 박성민
public class ArticleDeleteSuccess implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		if((boolean) session.getAttribute("ArticleDeleteSuccess")) {
			...
			session.removeAttribute("ArticleDeleteSuccess");
			...
			forward.setPath("/views/board/ArticleDeleteSuccess.jsp");
		}
		else {
