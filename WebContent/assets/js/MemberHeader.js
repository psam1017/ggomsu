...
function showAlarmList(alarmList){
	...
	if(alarmList != null && alarmList.length != 0){
		...
		text = '<div class="dropdown-notifications-item-content d-flex justify-content-center p-3 border-top"><div class="dropdown-notifications-item-content-text">업데이트된 알림이 없습니다.</div></div>';
	}
