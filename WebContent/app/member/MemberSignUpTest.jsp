	...
	<section id="signUp">
        ...
        <form action="${pageContext.request.contextPath}/member/member-sign-up-ok" id="signUpForm" name="signUpForm" method="post">
            <ul id="signUpUl">
                ...
                <li class="signUpLi">성별: 남성<input type="radio" name="sex" value="M" checked>
                        	여성<input type="radio" name="sex" value="F"></li>
                ...
                <li class="signUpLi"><input type="submit" value="회원가입"></li>
            </ul>
        </form>
    </section>
</body>
